; Disassembly of file: /home/bobkuo/eclipse-workspace/nasmCode/write_vga_mem.o
; Fri Apr 24 20:23:28 2020
; Mode: 32 bits
; Syntax: YASM/NASM
...
SECTION .eh_frame align=4 noexecute                     ; section number 4, const
        ...
        dd CMain-$+3E6H                                 ; 005C _ 00000442 (rel)
        ...
        dd CMain-$+3E3H                                 ; 007C _ 0000045F (rel)
        ...
        dd CMain-$+46FH                                 ; 009C _ 0000050B (rel)
        ...
        dd CMain-$+4A1H                                 ; 00BC _ 0000055D (rel)
        ...
        dd CMain-$+4D3H                                 ; 00DC _ 000005AF (rel)
        ...
        dd CMain-$+644H                                 ; 00FC _ 00000740 (rel)
        ...
        dd CMain-$+6FEH                                 ; 011C _ 0000081A (rel)
        ...
        dd CMain-$+749H                                 ; 0140 _ 00000889 (rel)
        ...
        dd CMain-$+788H                                 ; 0160 _ 000008E8 (rel)
        ...
        dd CMain-$+78CH                                 ; 0180 _ 0000090C (rel)
        ...
        dd CMain-$+7B4H                                 ; 01A0 _ 00000954 (rel)
        dd 00000084H, 080E4100H                         ; 01A4 _ 132 135151872 
        dd 0D420285H, 0C5800205H                        ; 01AC _ 222429829 -981466619 
        dd 0004040CH, 0000001CH                         ; 01B4 _ 263180 28 
        dd 000001BCH                                    ; 01BC _ 444 
        dd CMain-$+818H                                 ; 01C0 _ 000009D8 (rel)
        ...
        dd CMain-$+818H                                 ; 01E0 _ 000009F8 (rel)
        ...
        dd CMain-$+829H                                 ; 0200 _ 00000A29 (rel)
        ...
        dd CMain-$+840H                                 ; 0220 _ 00000A60 (rel)
        ...
        dd CMain-$+86FH                                 ; 0240 _ 00000AAF (rel)
        ...
        dd CMain-$+88DH                                 ; 0260 _ 00000AED (rel)
        ...
        dd CMain-$+8EDH                                 ; 0280 _ 00000B6D (rel)
        ...
        dd CMain-$+93DH                                 ; 02A0 _ 00000BDD (rel)
        ...
        dd CMain-$+932H                                 ; 02C0 _ 00000BF2 (rel)
        ...
        dd CMain-$+0A51H                                ; 02E0 _ 00000D31 (rel)
        ...
        dd CMain-$+0ACEH                                ; 0300 _ 00000DCE (rel)
        ...
        dd CMain-$+0AFCH                                ; 0324 _ 00000E20 (rel)
        ...
        dd CMain-$+0B21H                                ; 0344 _ 00000E65 (rel)
        ...
        dd CMain-$+0B60H                                ; 0364 _ 00000EC4 (rel)
        dd 00000006H, 080E4100H                         ; 0368 _ 6 135151872 
        dd 0D420285H, 0CC54205H                         ; 0370 _ 222429829 214254085 
        dd 00000404H                                    ; 0378 _ 1028 
