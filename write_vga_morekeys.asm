; Disassembly of file: write_vga_morekeys.o
; Wed Apr 22 15:48:11 2020
; Mode: 32 bits
; Syntax: YASM/NASM
...
CMain:  ; Function begin
        ...
        movzx   eax, word [?_035]                       ; 001F _ 0F B7. 05, 00000104(d)
        cwde                                            ; 0026 _ 98
        mov     dword [ebp-10H], eax                    ; 0027 _ 89. 45, F0
        movzx   eax, word [?_036]                       ; 002A _ 0F B7. 05, 00000106(d)
        cwde                                            ; 0031 _ 98
        ...
        push    ?_037                                   ; 030B _ 68, 00000000(d)
        push    7                                       ; 0310 _ 6A, 07
...
init_palette:; Function begin
        ...
        push    table_rgb.1490                          ; 0389 _ 68, 00000020(d)
...
?_021:  mov     eax, dword [ebp-4H]                     ; 06A2 _ 8B. 45, FC
        ...
        add     eax, cursor.1548                        ; 06AF _ 05, 00000060(d)
...
?_022:  mov     eax, dword [ebp-4H]                     ; 06D4 _ 8B. 45, FC
        ...
        add     eax, cursor.1548                        ; 06E1 _ 05, 00000060(d)
...
?_023:  mov     eax, dword [ebp-4H]                     ; 0706 _ 8B. 45, FC
        ...
        add     eax, cursor.1548                        ; 0713 _ 05, 00000060(d)
...
intHandlerFromC:; Function begin
        ...
        sub     esp, 40                                 ; 07CA _ 83. EC, 28
        mov     eax, dword [bootInfo]                   ; 07CD _ A1, 00000100(d)
        mov     dword [ebp-1CH], eax                    ; 07D2 _ 89. 45, E4
        movzx   eax, word [?_035]                       ; 07D5 _ 0F B7. 05, 00000104(d)
        cwde                                            ; 07DC _ 98
        mov     dword [ebp-18H], eax                    ; 07DD _ 89. 45, E8
        movzx   eax, word [?_036]                       ; 07E0 _ 0F B7. 05, 00000106(d)
        cwde                                            ; 07E7 _ 98
        mov     dword [ebp-14H], eax                    ; 07E8 _ 89. 45, EC
        sub     esp, 8                                  ; 07EB _ 83. EC, 08
        push    33                                      ; 07EE _ 6A, 21
        push    32                                      ; 07F0 _ 6A, 20
        call    io_out8                                 ; 07F2 _ E8, FFFFFFFC(rel)
        add     esp, 16                                 ; 07F7 _ 83. C4, 10
        mov     byte [ebp-1DH], 0                       ; 07FA _ C6. 45, E3, 00
        sub     esp, 12                                 ; 07FE _ 83. EC, 0C
        push    96                                      ; 0801 _ 6A, 60
        call    io_in8                                  ; 0803 _ E8, FFFFFFFC(rel)
        add     esp, 16                                 ; 0808 _ 83. C4, 10
        mov     byte [ebp-1DH], al                      ; 080B _ 88. 45, E3
        movzx   eax, byte [ebp-1DH]                     ; 080E _ 0F B6. 45, E3
        sub     esp, 12                                 ; 0812 _ 83. EC, 0C
        push    eax                                     ; 0815 _ 50
        call    charToHexStr                            ; 0816 _ E8, FFFFFFFC(rel)
        add     esp, 16                                 ; 081B _ 83. C4, 10
        mov     dword [ebp-10H], eax                    ; 081E _ 89. 45, F0
        mov     dword [ebp-0CH], 0                      ; 0821 _ C7. 45, F4, 00000000
        sub     esp, 8                                  ; 0828 _ 83. EC, 08
        push    dword [ebp-10H]                         ; 082B _ FF. 75, F0
        push    7                                       ; 082E _ 6A, 07
        push    0                                       ; 0830 _ 6A, 00
        push    dword [ebp-0CH]                         ; 0832 _ FF. 75, F4
        push    dword [ebp-18H]                         ; 0835 _ FF. 75, E8
        push    dword [ebp-1CH]                         ; 0838 _ FF. 75, E4
        call    showString                              ; 083B _ E8, FFFFFFFC(rel)
...
charToHexVal:; Function begin
        ...
        sub     esp, 4                                  ; 0849 _ 83. EC, 04
        mov     eax, dword [ebp+8H]                     ; 084C _ 8B. 45, 08
        mov     byte [ebp-4H], al                       ; 084F _ 88. 45, FC
        cmp     byte [ebp-4H], 9                        ; 0852 _ 80. 7D, FC, 09
        jle     ?_031                                   ; 0856 _ 7E, 09
        movzx   eax, byte [ebp-4H]                      ; 0858 _ 0F B6. 45, FC
        add     eax, 55                                 ; 085C _ 83. C0, 37
        jmp     ?_032                                   ; 085F _ EB, 07

?_031:  movzx   eax, byte [ebp-4H]                      ; 0861 _ 0F B6. 45, FC
        add     eax, 48                                 ; 0865 _ 83. C0, 30
?_032:  leave                                           ; 0868 _ C9
        ret                                             ; 0869 _ C3
; charToHexVal End of function

charToHexStr:; Function begin
        push    ebp                                     ; 086A _ 55
        mov     ebp, esp                                ; 086B _ 89. E5
        sub     esp, 20                                 ; 086D _ 83. EC, 14
        mov     eax, dword [ebp+8H]                     ; 0870 _ 8B. 45, 08
        mov     byte [ebp-14H], al                      ; 0873 _ 88. 45, EC
        mov     dword [ebp-4H], 0                       ; 0876 _ C7. 45, FC, 00000000
        movzx   eax, byte [ebp-14H]                     ; 087D _ 0F B6. 45, EC
        and     eax, 0FH                                ; 0881 _ 83. E0, 0F
        mov     byte [ebp-5H], al                       ; 0884 _ 88. 45, FB
        movsx   eax, byte [ebp-5H]                      ; 0887 _ 0F BE. 45, FB
        push    eax                                     ; 088B _ 50
        call    charToHexVal                            ; 088C _ E8, FFFFFFFC(rel)
        add     esp, 4                                  ; 0891 _ 83. C4, 04
        mov     byte [?_034], al                        ; 0894 _ A2, 00000003(d)
        shr     byte [ebp-14H], 4                       ; 0899 _ C0. 6D, EC, 04
        movzx   eax, byte [ebp-14H]                     ; 089D _ 0F B6. 45, EC
        movsx   eax, al                                 ; 08A1 _ 0F BE. C0
        push    eax                                     ; 08A4 _ 50
        call    charToHexVal                            ; 08A5 _ E8, FFFFFFFC(rel)
        add     esp, 4                                  ; 08AA _ 83. C4, 04
        mov     byte [?_033], al                        ; 08AD _ A2, 00000002(d)
        mov     eax, keyvalue                           ; 08B2 _ B8, 00000000(d)
        leave                                           ; 08B7 _ C9
        ret                                             ; 08B8 _ C3
...
?_034:  db 00H, 00H, 00H, 00H, 00H, 00H, 00H, 00H       ; 0003 _ ........
