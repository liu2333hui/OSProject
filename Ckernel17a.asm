; Disassembly of file: /home/bobkuo/eclipse-workspace/nasmCode/Ckernel17a.o
; Mon Apr 27 19:47:59 2020
; Mode: 32 bits
; Syntax: YASM/NASM
...
CMain:  ; Function begin
        ...
        movzx   eax, word [?_091]                       ; 001F _ 0F B7. 05, 00000104(d)
        cwde                                            ; 0026 _ 98
        mov     dword [ebp-30H], eax                    ; 0027 _ 89. 45, D0
        movzx   eax, word [?_092]                       ; 002A _ 0F B7. 05, 00000106(d)
        cwde                                            ; 0031 _ 98
        ...
        push    ?_081                                   ; 03AE _ 68, 00000000(d)
        push    7                                       ; 03B3 _ 6A, 07
        push    0                                       ; 03B5 _ 6A, 00
        push    0                                       ; 03B7 _ 6A, 00
        ...
        push    ?_082                                   ; 03E7 _ 68, 0000000F(d)
        push    7                                       ; 03EC _ 6A, 07
        push    0                                       ; 03EE _ 6A, 00
...
?_003:  mov     eax, dword [ebp-10H]                    ; 04B0 _ 8B. 45, F0
        ...
        mov     eax, dword [showPos.1645]               ; 04C5 _ A1, 00000300(d)
        add     eax, 32                                 ; 04CA _ 83. C0, 20
        mov     dword [showPos.1645], eax               ; 04CD _ A3, 00000300(d)
...
init_palette:; Function begin
        ...
        push    table_rgb.1653                          ; 0523 _ 68, 00000020(d)
...
?_024:  mov     eax, dword [ebp-4H]                     ; 083C _ 8B. 45, FC
        ...
        add     eax, cursor.1711                        ; 0849 _ 05, 00000060(d)
...
?_025:  mov     eax, dword [ebp-4H]                     ; 086E _ 8B. 45, FC
        ...
        add     eax, cursor.1711                        ; 087B _ 05, 00000060(d)
...
?_026:  mov     eax, dword [ebp-4H]                     ; 08A0 _ 8B. 45, FC
        ...
        add     eax, cursor.1711                        ; 08AD _ 05, 00000060(d)
...
intHandlerFromC:; Function begin
        ...
        movzx   eax, word [?_091]                       ; 096F _ 0F B7. 05, 00000104(d)
        cwde                                            ; 0976 _ 98
        mov     dword [ebp-10H], eax                    ; 0977 _ 89. 45, F0
        movzx   eax, word [?_092]                       ; 097A _ 0F B7. 05, 00000106(d)
        cwde                                            ; 0981 _ 98
...
charToHexStr:; Function begin
        ...
        mov     byte [?_090], al                        ; 0A07 _ A2, 00000003(d)
        ...
        mov     byte [?_089], al                        ; 0A20 _ A2, 00000002(d)
...
intToHexStr:; Function begin
        ...
        mov     byte [str.1758], 48                     ; 0A32 _ C6. 05, 00000304(d), 30
        mov     byte [?_093], 88                        ; 0A39 _ C6. 05, 00000305(d), 58
        mov     byte [?_094], 0                         ; 0A40 _ C6. 05, 0000030E(d), 00
...
?_036:  mov     eax, dword [ebp+8H]                     ; 0A57 _ 8B. 45, 08
        ...
        mov     byte [str.1758+eax], dl                 ; 0A76 _ 88. 90, 00000304(d)
...
?_037:  mov     eax, dword [ebp-4H]                     ; 0A7E _ 8B. 45, FC
        ...
        mov     byte [str.1758+eax], dl                 ; 0A8E _ 88. 90, 00000304(d)
...
?_039:  cmp     dword [ebp-0CH], 0                      ; 0A9C _ 83. 7D, F4, 00
        ...
        mov     eax, str.1758                           ; 0AA2 _ B8, 00000304(d)
        leave                                           ; 0AA7 _ C9
        ret                                             ; 0AA8 _ C3
...
computeMousePosition:; Function begin
        ...
        movzx   eax, word [?_091]                       ; 0E08 _ 0F B7. 05, 00000104(d)
        cwde                                            ; 0E0F _ 98
        mov     dword [ebp-8H], eax                     ; 0E10 _ 89. 45, F8
        movzx   eax, word [?_092]                       ; 0E13 _ 0F B7. 05, 00000106(d)
        cwde                                            ; 0E1A _ 98
...
eraseMouse:; Function begin
        ...
        movzx   eax, word [?_091]                       ; 0EA6 _ 0F B7. 05, 00000104(d)
        cwde                                            ; 0EAD _ 98
        mov     dword [ebp-0CH], eax                    ; 0EAE _ 89. 45, F4
        movzx   eax, word [?_092]                       ; 0EB1 _ 0F B7. 05, 00000106(d)
        cwde                                            ; 0EB8 _ 98
...
drawMouse:; Function begin
        ...
        movzx   eax, word [?_091]                       ; 0EF7 _ 0F B7. 05, 00000104(d)
        cwde                                            ; 0EFE _ 98
        mov     dword [ebp-8H], eax                     ; 0EFF _ 89. 45, F8
        movzx   eax, word [?_092]                       ; 0F02 _ 0F B7. 05, 00000106(d)
        cwde                                            ; 0F09 _ 98
...
showMemoryInfo:; Function begin
        ...
        push    ?_083                                   ; 0FD9 _ 68, 00000013(d)
        push    eax                                     ; 0FDE _ 50
        ...
        push    ?_084                                   ; 1033 _ 68, 0000001D(d)
        push    eax                                     ; 1038 _ 50
        ...
        push    ?_085                                   ; 108F _ 68, 00000029(d)
        push    eax                                     ; 1094 _ 50
        ...
        push    ?_086                                   ; 10EC _ 68, 00000035(d)
        push    eax                                     ; 10F1 _ 50
        ...
        push    ?_087                                   ; 1149 _ 68, 00000041(d)
        push    eax                                     ; 114E _ 50
        ...
        push    ?_088                                   ; 11A6 _ 68, 0000004E(d)
        push    eax                                     ; 11AB _ 50
...
SECTION .eh_frame align=4 noexecute                     ; section number 3, const
        ...
        dd 0004040CH, 00000024H                         ; 03F0 _ 263180 36 
        dd 0000007CH                                    ; 03F8 _ 124 
        dd CMain-$+0EEAH                                ; 03FC _ 000012E6 (rel)
        dd 00000216H, 080E4100H                         ; 0400 _ 534 135151872 
        dd 0D420285H, 03834405H                         ; 0408 _ 222429829 58934277 
        dd 0C3020D03H, 040CC541H                        ; 0410 _ -1023275773 67945793 
        dd 00000004H, 0000001CH                         ; 0418 _ 4 28 
        dd 000000A4H                                    ; 0420 _ 164 
        dd CMain-$+10D8H                                ; 0424 _ 000014FC (rel)
        dd 0000002CH, 080E4100H                         ; 0428 _ 44 135151872 
        dd 0D420285H, 0CC56805H                         ; 0430 _ 222429829 214263813 
        dd 00000404H                                    ; 0438 _ 1028 
...
?_090:  db 00H, 00H, 00H, 00H, 00H                      ; 0003 _ .....
