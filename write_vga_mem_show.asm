; Disassembly of file: /home/bobkuo/eclipse-workspace/nasmCode/write_vga_mem_show.o
; Sat Apr 25 20:13:23 2020
; Mode: 32 bits
; Syntax: YASM/NASM
...
CMain:  ; Function begin
        ...
        push    ?_068                                   ; 03AE _ 68, 00000000(d)
        push    7                                       ; 03B3 _ 6A, 07
        push    0                                       ; 03B5 _ 6A, 00
        push    0                                       ; 03B7 _ 6A, 00
        ...
        push    ?_069                                   ; 03E7 _ 68, 0000000F(d)
        push    7                                       ; 03EC _ 6A, 07
        push    0                                       ; 03EE _ 6A, 00
...
intHandlerFromC:; Function begin
        ...
        movzx   eax, word [?_064]                       ; 096F _ 0F B7. 05, 00000104(d)
        cwde                                            ; 0976 _ 98
        mov     dword [ebp-10H], eax                    ; 0977 _ 89. 45, F0
        movzx   eax, word [?_065]                       ; 097A _ 0F B7. 05, 00000106(d)
        cwde                                            ; 0981 _ 98
...
charToHexStr:; Function begin
        ...
        mov     byte [?_063], al                        ; 0A07 _ A2, 00000003(d)
        ...
        mov     byte [?_062], al                        ; 0A20 _ A2, 00000002(d)
...
intToHexStr:; Function begin
        ...
        mov     byte [?_066], 88                        ; 0A39 _ C6. 05, 000001FD(d), 58
        mov     byte [?_067], 0                         ; 0A40 _ C6. 05, 00000206(d), 00
...
computeMousePosition:; Function begin
        ...
        movzx   eax, word [?_064]                       ; 0E08 _ 0F B7. 05, 00000104(d)
        cwde                                            ; 0E0F _ 98
        mov     dword [ebp-8H], eax                     ; 0E10 _ 89. 45, F8
        movzx   eax, word [?_065]                       ; 0E13 _ 0F B7. 05, 00000106(d)
        cwde                                            ; 0E1A _ 98
...
eraseMouse:; Function begin
        ...
        movzx   eax, word [?_064]                       ; 0EA6 _ 0F B7. 05, 00000104(d)
        cwde                                            ; 0EAD _ 98
        mov     dword [ebp-0CH], eax                    ; 0EAE _ 89. 45, F4
        movzx   eax, word [?_065]                       ; 0EB1 _ 0F B7. 05, 00000106(d)
        cwde                                            ; 0EB8 _ 98
...
drawMouse:; Function begin
        ...
        movzx   eax, word [?_064]                       ; 0EF7 _ 0F B7. 05, 00000104(d)
        cwde                                            ; 0EFE _ 98
        mov     dword [ebp-8H], eax                     ; 0EFF _ 89. 45, F8
        movzx   eax, word [?_065]                       ; 0F02 _ 0F B7. 05, 00000106(d)
        cwde                                            ; 0F09 _ 98
...
showMemoryInfo:; Function begin
        ...
        push    ?_070                                   ; 0FD9 _ 68, 00000013(d)
        push    eax                                     ; 0FDE _ 50
        ...
        push    ?_071                                   ; 1033 _ 68, 0000001D(d)
        push    eax                                     ; 1038 _ 50
        ...
        push    ?_072                                   ; 108F _ 68, 00000029(d)
        push    eax                                     ; 1094 _ 50
        ...
        push    ?_073                                   ; 10EC _ 68, 00000035(d)
        push    eax                                     ; 10F1 _ 50
        ...
        push    ?_074                                   ; 1149 _ 68, 00000041(d)
        push    eax                                     ; 114E _ 50
        ...
        push    ?_075                                   ; 11A6 _ 68, 0000004E(d)
        push    eax                                     ; 11AB _ 50
...
?_063:  db 00H, 00H, 00H, 00H, 00H                      ; 0003 _ .....
