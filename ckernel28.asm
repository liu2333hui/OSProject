; Disassembly of file: /home/bobkuo/eclipse-workspace/nasmCode/ckernel28.o
; Mon May 11 22:22:46 2020
; Mode: 32 bits
; Syntax: YASM/NASM
...
SECTION .eh_frame align=4 noexecute                     ; section number 3, const
        ...
        dd 000007C7H, 080E4100H                         ; 0024 _ 1991 135151872 
        dd 0D420285H, 03864505H                         ; 002C _ 222429829 59131141 
        dd 00000483H, 0000001CH                         ; 0034 _ 1155 28 
        dd 0000003CH                                    ; 003C _ 60 
        dd CMain-$+787H                                 ; 0040 _ 000007C7 (rel)
        ...
        dd CMain-$+788H                                 ; 0060 _ 000007E8 (rel)
        ...
        dd CMain-$+785H                                 ; 0080 _ 00000805 (rel)
        dd 000000ACH, 080E4100H                         ; 0084 _ 172 135151872 
        dd 0D420285H, 0C5A80205H                        ; 008C _ 222429829 -978845179 
        dd 0004040CH, 0000001CH                         ; 0094 _ 263180 28 
        dd 0000009CH                                    ; 009C _ 156 
        dd CMain-$+811H                                 ; 00A0 _ 000008B1 (rel)
        dd 00000052H, 080E4100H                         ; 00A4 _ 82 135151872 
        dd 0D420285H, 0C54E0205H                        ; 00AC _ 222429829 -984743419 
        dd 0004040CH, 00000020H                         ; 00B4 _ 263180 32 
        dd 000000BCH                                    ; 00BC _ 188 
        dd CMain-$+843H                                 ; 00C0 _ 00000903 (rel)
        dd 00000084H, 080E4100H                         ; 00C4 _ 132 135151872 
        dd 0D420285H, 03834405H                         ; 00CC _ 222429829 58934277 
        dd 0C3C57C02H, 0004040CH                        ; 00D4 _ -1010467838 263180 
        dd 0000001CH, 000000E0H                         ; 00DC _ 28 224 
        dd CMain-$+8A3H                                 ; 00E4 _ 00000987 (rel)
        dd 00000191H, 080E4100H                         ; 00E8 _ 401 135151872 
        dd 0D420285H, 018D0305H                         ; 00F0 _ 222429829 26018565 
        dd 04040CC5H, 0000001CH                         ; 00F8 _ 67374277 28 
        dd 00000100H                                    ; 0100 _ 256 
        dd CMain-$+0A14H                                ; 0104 _ 00000B18 (rel)
        dd 000000DAH, 080E4100H                         ; 0108 _ 218 135151872 
        dd 0D420285H, 0C5D60205H                        ; 0110 _ 222429829 -975830523 
        dd 0004040CH, 00000020H                         ; 0118 _ 263180 32 
        dd 00000120H                                    ; 0120 _ 288 
        dd CMain-$+0ACEH                                ; 0124 _ 00000BF2 (rel)
        dd 0000006FH, 080E4100H                         ; 0128 _ 111 135151872 
        dd 0D420285H, 03834405H                         ; 0130 _ 222429829 58934277 
        dd 41C36602H, 04040CC5H                         ; 0138 _ 1103324674 67374277 
        dd 0000001CH, 00000144H                         ; 0140 _ 28 324 
        dd CMain-$+0B19H                                ; 0148 _ 00000C61 (rel)
        dd 0000005FH, 080E4100H                         ; 014C _ 95 135151872 
        dd 0D420285H, 0C55B0205H                        ; 0154 _ 222429829 -983891451 
        dd 0004040CH, 0000001CH                         ; 015C _ 263180 28 
        dd 00000164H                                    ; 0164 _ 356 
        dd CMain-$+0B58H                                ; 0168 _ 00000CC0 (rel)
        dd 00000024H, 080E4100H                         ; 016C _ 36 135151872 
        dd 0D420285H, 0CC56005H                         ; 0174 _ 222429829 214261765 
        dd 00000404H, 0000001CH                         ; 017C _ 1028 28 
        dd 00000184H                                    ; 0184 _ 388 
        dd CMain-$+0B5CH                                ; 0188 _ 00000CE4 (rel)
        dd 00000048H, 080E4100H                         ; 018C _ 72 135151872 
        dd 0D420285H, 0C5440205H                        ; 0194 _ 222429829 -985398779 
        dd 0004040CH, 0000001CH                         ; 019C _ 263180 28 
        dd 000001A4H                                    ; 01A4 _ 420 
        dd CMain-$+0B84H                                ; 01A8 _ 00000D2C (rel)
        dd 0000007DH, 080E4100H                         ; 01AC _ 125 135151872 
        dd 0D420285H, 0C5790205H                        ; 01B4 _ 222429829 -981925371 
        dd 0004040CH, 0000001CH                         ; 01BC _ 263180 28 
        dd 000001C4H                                    ; 01C4 _ 452 
        dd CMain-$+0BE1H                                ; 01C8 _ 00000DA9 (rel)
        dd 00000020H, 080E4100H                         ; 01CC _ 32 135151872 
        dd 0D420285H, 0CC55C05H                         ; 01D4 _ 222429829 214260741 
        dd 00000404H, 0000001CH                         ; 01DC _ 1028 28 
        dd 000001E4H                                    ; 01E4 _ 484 
        dd CMain-$+0BE1H                                ; 01E8 _ 00000DC9 (rel)
        dd 00000031H, 080E4100H                         ; 01EC _ 49 135151872 
        dd 0D420285H, 0CC56D05H                         ; 01F4 _ 222429829 214265093 
        dd 00000404H, 0000001CH                         ; 01FC _ 1028 28 
        dd 00000204H                                    ; 0204 _ 516 
        dd putblock-$+208H                              ; 0208 _ 00000DFA (rel)
        dd 0000003EH, 080E4100H                         ; 020C _ 62 135151872 
        dd 0D420285H, 0CC57A05H                         ; 0214 _ 222429829 214268421 
        dd 00000404H, 0000001CH                         ; 021C _ 1028 28 
        dd 00000224H                                    ; 0224 _ 548 
        dd CMain-$+0C10H                                ; 0228 _ 00000E38 (rel)
        dd 0000004FH, 080E4100H                         ; 022C _ 79 135151872 
        dd 0D420285H, 0C54B0205H                        ; 0234 _ 222429829 -984940027 
        dd 0004040CH, 0000001CH                         ; 023C _ 263180 28 
        dd 00000244H                                    ; 0244 _ 580 
        dd CMain-$+0C3FH                                ; 0248 _ 00000E87 (rel)
        dd 0000013FH, 080E4100H                         ; 024C _ 319 135151872 
        dd 0D420285H, 013B0305H                         ; 0254 _ 222429829 20644613 
        dd 04040CC5H, 0000001CH                         ; 025C _ 67374277 28 
        dd 00000264H                                    ; 0264 _ 612 
        dd CMain-$+0D5EH                                ; 0268 _ 00000FC6 (rel)
        dd 00000109H, 080E4100H                         ; 026C _ 265 135151872 
        dd 0D420285H, 01050305H                         ; 0274 _ 222429829 17105669 
        dd 04040CC5H, 0000001CH                         ; 027C _ 67374277 28 
        dd 00000284H                                    ; 0284 _ 644 
        dd CMain-$+0E47H                                ; 0288 _ 000010CF (rel)
        dd 000000C1H, 080E4100H                         ; 028C _ 193 135151872 
        dd 0D420285H, 0C5BD0205H                        ; 0294 _ 222429829 -977468923 
        dd 0004040CH, 0000001CH                         ; 029C _ 263180 28 
        dd 000002A4H                                    ; 02A4 _ 676 
        dd ?_053-$+2A8H                                 ; 02A8 _ 00001190 (rel)
        dd 00000266H, 080E4100H                         ; 02AC _ 614 135151872 
        dd 0D420285H, 02620305H                         ; 02B4 _ 222429829 39977733 
        dd 04040CC5H, 00000020H                         ; 02BC _ 67374277 32 
        dd 000002C4H                                    ; 02C4 _ 708 
        dd CMain-$+112EH                                ; 02C8 _ 000013F6 (rel)
        dd 0000021DH, 080E4100H                         ; 02CC _ 541 135151872 
        dd 0D420285H, 03834105H                         ; 02D4 _ 222429829 58933509 
        dd 0C5021803H, 04040CC3H                        ; 02DC _ -989718525 67374275 
        dd 00000020H, 000002E8H                         ; 02E4 _ 32 744 
        dd CMain-$+1327H                                ; 02EC _ 00001613 (rel)
        dd 0000023FH, 080E4100H                         ; 02F0 _ 575 135151872 
        dd 0D420285H, 03834405H                         ; 02F8 _ 222429829 58934277 
        dd 0C5023703H, 04040CC3H                        ; 0300 _ -989710589 67374275 
        dd 0000001CH, 0000030CH                         ; 0308 _ 28 780 
        dd CMain-$+1542H                                ; 0310 _ 00001852 (rel)
        dd 000000C5H, 080E4100H                         ; 0314 _ 197 135151872 
        dd 0D420285H, 0C5C10205H                        ; 031C _ 222429829 -977206779 
        dd 0004040CH, 0000002CH                         ; 0324 _ 263180 44 
        dd 0000032CH                                    ; 032C _ 812 
        dd CMain-$+15E7H                                ; 0330 _ 00001917 (rel)
        dd 000001E4H, 080E4100H                         ; 0334 _ 484 135151872 
        dd 0D420285H, 03874605H                         ; 033C _ 222429829 59196933 
        dd 05830486H, 0C301D703H                        ; 0344 _ 92472454 -1023289597 
        dd 0C741C641H, 040CC541H                        ; 034C _ -951990719 67945793 
        dd 00000004H, 0000001CH                         ; 0354 _ 4 28 
        dd 0000035CH                                    ; 035C _ 860 
        dd CMain-$+179BH                                ; 0360 _ 00001AFB (rel)
        dd 000000A3H, 080E4100H                         ; 0364 _ 163 135151872 
        dd 0D420285H, 0C59F0205H                        ; 036C _ 222429829 -979435003 
        dd 0004040CH, 00000014H                         ; 0374 _ 263180 20 
        dd 00000000H, 00527A01H                         ; 037C _ 0 5405185 
        dd 01087C01H, 04040C1BH                         ; 0384 _ 17333249 67374107 
        dd 00000188H, 0000001CH                         ; 038C _ 392 28 
        dd 0000001CH                                    ; 0394 _ 28 
        dd CMain-$+1806H                                ; 0398 _ 00001B9E (rel)
        dd 0000002DH, 080E4100H                         ; 039C _ 45 135151872 
        dd 0D420285H, 0CC56905H                         ; 03A4 _ 222429829 214264069 
        dd 00000404H, 0000001CH                         ; 03AC _ 1028 28 
        dd 0000003CH                                    ; 03B4 _ 60 
        dd CMain-$+1813H                                ; 03B8 _ 00001BCB (rel)
        dd 00000039H, 080E4100H                         ; 03BC _ 57 135151872 
        dd 0D420285H, 0CC57505H                         ; 03C4 _ 222429829 214267141 
        dd 00000404H, 0000001CH                         ; 03CC _ 1028 28 
        dd 0000005CH                                    ; 03D4 _ 92 
        dd CMain-$+182CH                                ; 03D8 _ 00001C04 (rel)
        dd 000000ACH, 080E4100H                         ; 03DC _ 172 135151872 
        dd 0D420285H, 0C5A80205H                        ; 03E4 _ 222429829 -978845179 
        dd 0004040CH, 00000024H                         ; 03EC _ 263180 36 
        dd 0000007CH                                    ; 03F4 _ 124 
        dd CMain-$+18B8H                                ; 03F8 _ 00001CB0 (rel)
        dd 00000216H, 080E4100H                         ; 03FC _ 534 135151872 
        dd 0D420285H, 03834405H                         ; 0404 _ 222429829 58934277 
        dd 0C3020D03H, 040CC541H                        ; 040C _ -1023275773 67945793 
        dd 00000004H, 0000001CH                         ; 0414 _ 4 28 
        dd 000000A4H                                    ; 041C _ 164 
        dd CMain-$+1AA6H                                ; 0420 _ 00001EC6 (rel)
        dd 0000002CH, 080E4100H                         ; 0424 _ 44 135151872 
        dd 0D420285H, 0CC56805H                         ; 042C _ 222429829 214263813 
        dd 00000404H, 0000001CH                         ; 0434 _ 1028 28 
        dd 000000C4H                                    ; 043C _ 196 
        dd CMain-$+1AB2H                                ; 0440 _ 00001EF2 (rel)
        dd 0000002FH, 080E4100H                         ; 0444 _ 47 135151872 
        dd 0D420285H, 0CC56B05H                         ; 044C _ 222429829 214264581 
        dd 00000404H, 00000014H                         ; 0454 _ 1028 20 
        dd 00000000H, 00527A01H                         ; 045C _ 0 5405185 
        dd 01087C01H, 04040C1BH                         ; 0464 _ 17333249 67374107 
        dd 00000188H, 0000001CH                         ; 046C _ 392 28 
        dd 0000001CH                                    ; 0474 _ 28 
        dd CMain-$+1AA9H                                ; 0478 _ 00001F21 (rel)
        dd 000000C8H, 080E4100H                         ; 047C _ 200 135151872 
        dd 0D420285H, 0C5C40205H                        ; 0484 _ 222429829 -977010171 
        dd 0004040CH, 0000001CH                         ; 048C _ 263180 28 
        dd 0000003CH                                    ; 0494 _ 60 
        dd CMain-$+1B51H                                ; 0498 _ 00001FE9 (rel)
        dd 0000007AH, 080E4100H                         ; 049C _ 122 135151872 
        dd 0D420285H, 0C5760205H                        ; 04A4 _ 222429829 -982121979 
        dd 0004040CH, 0000001CH                         ; 04AC _ 263180 28 
        dd 0000005CH                                    ; 04B4 _ 92 
        dd CMain-$+1BABH                                ; 04B8 _ 00002063 (rel)
        dd 00000029H, 080E4100H                         ; 04BC _ 41 135151872 
        dd 0D420285H, 0CC56505H                         ; 04C4 _ 222429829 214263045 
        dd 00000404H, 00000028H                         ; 04CC _ 1028 40 
        dd 0000007CH                                    ; 04D4 _ 124 
        dd CMain-$+1BB4H                                ; 04D8 _ 0000208C (rel)
        dd 00000376H, 080E4100H                         ; 04DC _ 886 135151872 
        dd 0D420285H, 03864505H                         ; 04E4 _ 222429829 59131141 
        dd 6B030483H, 0C641C303H                        ; 04EC _ 1795359875 -968768765 
        dd 040CC541H, 00000004H                         ; 04F4 _ 67945793 4 
        dd 00000028H, 000000A8H                         ; 04FC _ 40 168 
        dd CMain-$+1EFEH                                ; 0504 _ 00002402 (rel)
        dd 00000067H, 080E4100H                         ; 0508 _ 103 135151872 
        dd 0D420285H, 03874605H                         ; 0510 _ 222429829 59196933 
        dd 05830486H, 41C35A02H                         ; 0518 _ 92472454 1103321602 
        dd 41C741C6H, 04040CC5H                         ; 0520 _ 1103577542 67374277 
        dd 00000020H, 000000D4H                         ; 0528 _ 32 212 
        dd CMain-$+1F39H                                ; 0530 _ 00002469 (rel)
        dd 000000EDH, 080E4100H                         ; 0534 _ 237 135151872 
        dd 0D420285H, 03834405H                         ; 053C _ 222429829 58934277 
        dd 0C3C5E502H, 0004040CH                        ; 0544 _ -1010440958 263180 
        dd 00000020H, 000000F8H                         ; 054C _ 32 248 
        dd CMain-$+2002H                                ; 0554 _ 00002556 (rel)
        dd 00000101H, 080E4100H                         ; 0558 _ 257 135151872 
        dd 0D420285H, 03834405H                         ; 0560 _ 222429829 58934277 
        dd 0C3C5F902H, 0004040CH                        ; 0568 _ -1010435838 263180 
        dd 0000001CH, 0000011CH                         ; 0570 _ 28 284 
        dd CMain-$+20DFH                                ; 0578 _ 00002657 (rel)
        dd 0000014CH, 080E4100H                         ; 057C _ 332 135151872 
        dd 0D420285H, 01480305H                         ; 0584 _ 222429829 21496581 
        dd 04040CC5H, 0000001CH                         ; 058C _ 67374277 28 
        dd 0000013CH                                    ; 0594 _ 316 
        dd CMain-$+220BH                                ; 0598 _ 000027A3 (rel)
        dd 000001AEH, 080E4100H                         ; 059C _ 430 135151872 
        dd 0D420285H, 01AA0305H                         ; 05A4 _ 222429829 27919109 
        dd 04040CC5H, 00000014H                         ; 05AC _ 67374277 20 
        dd 00000000H, 00527A01H                         ; 05B4 _ 0 5405185 
        dd 01087C01H, 04040C1BH                         ; 05BC _ 17333249 67374107 
        dd 00000188H, 0000001CH                         ; 05C4 _ 392 28 
        dd 0000001CH                                    ; 05CC _ 28 
        dd CMain-$+2381H                                ; 05D0 _ 00002951 (rel)
        dd 00000091H, 080E4100H                         ; 05D4 _ 145 135151872 
        dd 0D420285H, 0C58D0205H                        ; 05DC _ 222429829 -980614651 
        dd 0004040CH, 0000001CH                         ; 05E4 _ 263180 28 
        dd 0000003CH                                    ; 05EC _ 60 
        dd CMain-$+23F2H                                ; 05F0 _ 000029E2 (rel)
        dd 0000005DH, 080E4100H                         ; 05F4 _ 93 135151872 
        dd 0D420285H, 0C5590205H                        ; 05FC _ 222429829 -984022523 
        dd 0004040CH, 0000001CH                         ; 0604 _ 263180 28 
        dd 0000005CH                                    ; 060C _ 92 
        dd CMain-$+242FH                                ; 0610 _ 00002A3F (rel)
        dd 0000000FH, 080E4100H                         ; 0614 _ 15 135151872 
        dd 0D420285H, 0CC54B05H                         ; 061C _ 222429829 214256389 
        dd 00000404H, 0000001CH                         ; 0624 _ 1028 28 
        dd 0000007CH                                    ; 062C _ 124 
        dd CMain-$+241EH                                ; 0630 _ 00002A4E (rel)
        dd 00000022H, 080E4100H                         ; 0634 _ 34 135151872 
        dd 0D420285H, 0CC55E05H                         ; 063C _ 222429829 214261253 
        dd 00000404H, 0000001CH                         ; 0644 _ 1028 28 
        dd 0000009CH                                    ; 064C _ 156 
        dd CMain-$+2420H                                ; 0650 _ 00002A70 (rel)
        dd 00000019H, 080E4100H                         ; 0654 _ 25 135151872 
        dd 0D420285H, 0CC55505H                         ; 065C _ 222429829 214258949 
        dd 00000404H, 0000001CH                         ; 0664 _ 1028 28 
        dd 000000BCH                                    ; 066C _ 188 
        dd CMain-$+2419H                                ; 0670 _ 00002A89 (rel)
        dd 00000018H, 080E4100H                         ; 0674 _ 24 135151872 
        dd 0D420285H, 0CC55405H                         ; 067C _ 222429829 214258693 
        dd 00000404H, 00000014H                         ; 0684 _ 1028 20 
        dd 00000000H, 00527A01H                         ; 068C _ 0 5405185 
        dd 01087C01H, 04040C1BH                         ; 0694 _ 17333249 67374107 
        dd 00000188H, 0000001CH                         ; 069C _ 392 28 
        dd 0000001CH                                    ; 06A4 _ 28 
        dd CMain-$+23F9H                                ; 06A8 _ 00002AA1 (rel)
        dd 0000003EH, 080E4100H                         ; 06AC _ 62 135151872 
        dd 0D420285H, 0CC57A05H                         ; 06B4 _ 222429829 214268421 
        dd 00000404H, 0000001CH                         ; 06BC _ 1028 28 
        dd 0000003CH                                    ; 06C4 _ 60 
        dd CMain-$+2417H                                ; 06C8 _ 00002ADF (rel)
        dd 00000080H, 080E4100H                         ; 06CC _ 128 135151872 
        dd 0D420285H, 0C57C0205H                        ; 06D4 _ 222429829 -981728763 
        dd 0004040CH, 0000001CH                         ; 06DC _ 263180 28 
        dd 0000005CH                                    ; 06E4 _ 92 
        dd CMain-$+2477H                                ; 06E8 _ 00002B5F (rel)
        dd 00000070H, 080E4100H                         ; 06EC _ 112 135151872 
        dd 0D420285H, 0C56C0205H                        ; 06F4 _ 222429829 -982777339 
        dd 0004040CH, 0000001CH                         ; 06FC _ 263180 28 
        dd 0000007CH                                    ; 0704 _ 124 
        dd CMain-$+24C7H                                ; 0708 _ 00002BCF (rel)
        dd 00000015H, 080E4100H                         ; 070C _ 21 135151872 
        dd 0D420285H, 0CC55105H                         ; 0714 _ 222429829 214257925 
        dd 00000404H                                    ; 071C _ 1028 
