; Disassembly of file: /home/bobkuo/eclipse-workspace/nasmCode/ckernel24.o
; Thu Apr 30 17:50:26 2020
; Mode: 32 bits
; Syntax: YASM/NASM
...
SECTION .eh_frame align=4 noexecute                     ; section number 3, const
        ...
        dd 000000C8H, 080E4100H                         ; 04A8 _ 200 135151872 
        dd 0D420285H, 0C5C40205H                        ; 04B0 _ 222429829 -977010171 
        dd 0004040CH, 0000001CH                         ; 04B8 _ 263180 28 
        dd 0000003CH                                    ; 04C0 _ 60 
        dd CMain-$+1569H                                ; 04C4 _ 00001A2D (rel)
        dd 0000007AH, 080E4100H                         ; 04C8 _ 122 135151872 
        dd 0D420285H, 0C5760205H                        ; 04D0 _ 222429829 -982121979 
        dd 0004040CH, 0000001CH                         ; 04D8 _ 263180 28 
        dd 0000005CH                                    ; 04E0 _ 92 
        dd CMain-$+15C3H                                ; 04E4 _ 00001AA7 (rel)
        dd 00000029H, 080E4100H                         ; 04E8 _ 41 135151872 
        dd 0D420285H, 0CC56505H                         ; 04F0 _ 222429829 214263045 
        dd 00000404H, 00000028H                         ; 04F8 _ 1028 40 
        dd 0000007CH                                    ; 0500 _ 124 
        dd CMain-$+15CCH                                ; 0504 _ 00001AD0 (rel)
        dd 00000376H, 080E4100H                         ; 0508 _ 886 135151872 
        dd 0D420285H, 03864505H                         ; 0510 _ 222429829 59131141 
        dd 6B030483H, 0C641C303H                        ; 0518 _ 1795359875 -968768765 
        dd 040CC541H, 00000004H                         ; 0520 _ 67945793 4 
        dd 00000028H, 000000A8H                         ; 0528 _ 40 168 
        dd CMain-$+1916H                                ; 0530 _ 00001E46 (rel)
        dd 00000067H, 080E4100H                         ; 0534 _ 103 135151872 
        dd 0D420285H, 03874605H                         ; 053C _ 222429829 59196933 
        dd 05830486H, 41C35A02H                         ; 0544 _ 92472454 1103321602 
        dd 41C741C6H, 04040CC5H                         ; 054C _ 1103577542 67374277 
        dd 00000020H, 000000D4H                         ; 0554 _ 32 212 
        dd CMain-$+1951H                                ; 055C _ 00001EAD (rel)
        dd 000000EDH, 080E4100H                         ; 0560 _ 237 135151872 
        dd 0D420285H, 03834405H                         ; 0568 _ 222429829 58934277 
        dd 0C3C5E502H, 0004040CH                        ; 0570 _ -1010440958 263180 
        dd 00000020H, 000000F8H                         ; 0578 _ 32 248 
        dd CMain-$+1A1AH                                ; 0580 _ 00001F9A (rel)
        dd 00000101H, 080E4100H                         ; 0584 _ 257 135151872 
        dd 0D420285H, 03834405H                         ; 058C _ 222429829 58934277 
        dd 0C3C5F902H, 0004040CH                        ; 0594 _ -1010435838 263180 
        dd 0000001CH, 0000011CH                         ; 059C _ 28 284 
        dd CMain-$+1AF7H                                ; 05A4 _ 0000209B (rel)
        dd 0000014CH, 080E4100H                         ; 05A8 _ 332 135151872 
        dd 0D420285H, 01480305H                         ; 05B0 _ 222429829 21496581 
        dd 04040CC5H, 0000001CH                         ; 05B8 _ 67374277 28 
        dd 0000013CH                                    ; 05C0 _ 316 
        dd CMain-$+1C23H                                ; 05C4 _ 000021E7 (rel)
        dd 000001AEH, 080E4100H                         ; 05C8 _ 430 135151872 
        dd 0D420285H, 01AA0305H                         ; 05D0 _ 222429829 27919109 
        dd 04040CC5H                                    ; 05D8 _ 67374277 
