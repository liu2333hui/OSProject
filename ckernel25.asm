; Disassembly of file: /home/bobkuo/eclipse-workspace/nasmCode/ckernel25.o
; Mon May  4 22:20:12 2020
; Mode: 32 bits
; Syntax: YASM/NASM
...
SECTION .eh_frame align=4 noexecute                     ; section number 3, const
        ...
        dd CMain-$+3F4H                                 ; 005C _ 00000450 (rel)
        ...
        dd ?_004-$+7CH                                  ; 007C _ 0000046D (rel)
        ...
        dd CMain-$+47DH                                 ; 009C _ 00000519 (rel)
        ...
        dd CMain-$+4AFH                                 ; 00BC _ 0000056B (rel)
        ...
        dd CMain-$+50FH                                 ; 00E0 _ 000005EF (rel)
        ...
        dd CMain-$+680H                                 ; 0100 _ 00000780 (rel)
        ...
        dd CMain-$+73AH                                 ; 0120 _ 0000085A (rel)
        ...
        dd CMain-$+785H                                 ; 0144 _ 000008C9 (rel)
        ...
        dd CMain-$+7C4H                                 ; 0164 _ 00000928 (rel)
        ...
        dd CMain-$+7C8H                                 ; 0184 _ 0000094C (rel)
        ...
        dd CMain-$+7F0H                                 ; 01A4 _ 00000994 (rel)
        ...
        dd ?_029-$+1C4H                                 ; 01C4 _ 00000A11 (rel)
        ...
        dd ?_029-$+1E4H                                 ; 01E4 _ 00000A31 (rel)
        ...
        dd CMain-$+85EH                                 ; 0204 _ 00000A62 (rel)
        ...
        dd CMain-$+87CH                                 ; 0224 _ 00000AA0 (rel)
        ...
        dd CMain-$+8ABH                                 ; 0244 _ 00000AEF (rel)
        ...
        dd CMain-$+9CAH                                 ; 0264 _ 00000C2E (rel)
        ...
        dd CMain-$+0AB3H                                ; 0284 _ 00000D37 (rel)
        ...
        dd CMain-$+0B0BH                                ; 02A4 _ 00000DAF (rel)
        ...
        dd CMain-$+0D51H                                ; 02C4 _ 00001015 (rel)
        ...
        dd CMain-$+0F4AH                                ; 02E8 _ 00001232 (rel)
        ...
        dd CMain-$+1165H                                ; 030C _ 00001471 (rel)
        ...
        dd CMain-$+1205H                                ; 032C _ 00001531 (rel)
        dd 00000061H, 080E4100H                         ; 0330 _ 97 135151872 
        dd 0D420285H, 0C55D0205H                        ; 0338 _ 222429829 -983760379 
        ...
        dd CMain-$+122EH                                ; 0364 _ 00001592 (rel)
        ...
        dd CMain-$+123BH                                ; 0384 _ 000015BF (rel)
        ...
        dd CMain-$+1254H                                ; 03A4 _ 000015F8 (rel)
        ...
        dd CMain-$+12E0H                                ; 03C4 _ 000016A4 (rel)
        ...
        dd CMain-$+14CEH                                ; 03EC _ 000018BA (rel)
        ...
        dd CMain-$+14DAH                                ; 040C _ 000018E6 (rel)
        ...
        dd CMain-$+14D1H                                ; 0444 _ 00001915 (rel)
        ...
        dd CMain-$+1579H                                ; 0464 _ 000019DD (rel)
        ...
        dd CMain-$+15D3H                                ; 0484 _ 00001A57 (rel)
        ...
        dd CMain-$+15DCH                                ; 04A4 _ 00001A80 (rel)
        ...
        dd CMain-$+1926H                                ; 04D0 _ 00001DF6 (rel)
        ...
        dd CMain-$+1961H                                ; 04FC _ 00001E5D (rel)
        ...
        dd CMain-$+1A2AH                                ; 0520 _ 00001F4A (rel)
        ...
        dd CMain-$+1B07H                                ; 0544 _ 0000204B (rel)
        ...
        dd CMain-$+1C33H                                ; 0564 _ 00002197 (rel)
        ...
        dd CMain-$+1DA9H                                ; 059C _ 00002345 (rel)
        dd 0000006CH, 080E4100H                         ; 05A0 _ 108 135151872 
        dd 0D420285H, 0C5680205H                        ; 05A8 _ 222429829 -983039483 
        dd 0004040CH, 0000001CH                         ; 05B0 _ 263180 28 
        dd 0000003CH                                    ; 05B8 _ 60 
        dd CMain-$+1DF5H                                ; 05BC _ 000023B1 (rel)
        dd 00000046H, 080E4100H                         ; 05C0 _ 70 135151872 
        dd 0D420285H, 0C5420205H                        ; 05C8 _ 222429829 -985529851 
        dd 0004040CH, 00000014H                         ; 05D0 _ 263180 20 
        dd 00000000H, 00527A01H                         ; 05D8 _ 0 5405185 
        dd 01087C01H, 04040C1BH                         ; 05E0 _ 17333249 67374107 
        dd 00000188H, 0000001CH                         ; 05E8 _ 392 28 
        dd 0000001CH                                    ; 05F0 _ 28 
        dd CMain-$+1E03H                                ; 05F4 _ 000023F7 (rel)
        dd 0000003EH, 080E4100H                         ; 05F8 _ 62 135151872 
        dd 0D420285H, 0CC57A05H                         ; 0600 _ 222429829 214268421 
        dd 00000404H, 0000001CH                         ; 0608 _ 1028 28 
        dd 0000003CH                                    ; 0610 _ 60 
        dd CMain-$+1E21H                                ; 0614 _ 00002435 (rel)
        dd 00000080H, 080E4100H                         ; 0618 _ 128 135151872 
        dd 0D420285H, 0C57C0205H                        ; 0620 _ 222429829 -981728763 
        dd 0004040CH, 0000001CH                         ; 0628 _ 263180 28 
        dd 0000005CH                                    ; 0630 _ 92 
        dd CMain-$+1E81H                                ; 0634 _ 000024B5 (rel)
        dd 00000070H, 080E4100H                         ; 0638 _ 112 135151872 
        dd 0D420285H, 0C56C0205H                        ; 0640 _ 222429829 -982777339 
        dd 0004040CH, 0000001CH                         ; 0648 _ 263180 28 
        dd 0000007CH                                    ; 0650 _ 124 
        dd CMain-$+1ED1H                                ; 0654 _ 00002525 (rel)
        dd 00000015H, 080E4100H                         ; 0658 _ 21 135151872 
        dd 0D420285H, 0CC55105H                         ; 0660 _ 222429829 214257925 
        dd 00000404H                                    ; 0668 _ 1028 
