; Disassembly of file: /home/bobkuo/eclipse-workspace/nasmCode/Ckernel16.o
; Sat Apr 25 12:15:28 2020
; Mode: 32 bits
; Syntax: YASM/NASM
...
CMain:  ; Function begin
        ...
        movzx   eax, word [?_083]                       ; 001F _ 0F B7. 05, 00000104(d)
        cwde                                            ; 0026 _ 98
        mov     dword [ebp-30H], eax                    ; 0027 _ 89. 45, D0
        movzx   eax, word [?_084]                       ; 002A _ 0F B7. 05, 00000106(d)
        cwde                                            ; 0031 _ 98
        ...
        push    266174464                               ; 036F _ 68, 0FDD8000
        ...
        push    ?_073                                   ; 03AE _ 68, 00000000(d)
        push    7                                       ; 03B3 _ 6A, 07
        push    0                                       ; 03B5 _ 6A, 00
        push    0                                       ; 03B7 _ 6A, 00
        ...
        push    ?_074                                   ; 03E7 _ 68, 0000000F(d)
        push    7                                       ; 03EC _ 6A, 07
        push    0                                       ; 03EE _ 6A, 00
...
?_003:  mov     eax, dword [ebp-10H]                    ; 04B0 _ 8B. 45, F0
        ...
        mov     eax, dword [showPos.1588]               ; 04C5 _ A1, 000001F8(d)
        add     eax, 32                                 ; 04CA _ 83. C0, 20
        mov     dword [showPos.1588], eax               ; 04CD _ A3, 000001F8(d)
...
init_palette:; Function begin
        ...
        push    table_rgb.1597                          ; 0523 _ 68, 00000020(d)
...
?_024:  mov     eax, dword [ebp-4H]                     ; 083C _ 8B. 45, FC
        ...
        add     eax, cursor.1655                        ; 0849 _ 05, 00000060(d)
...
?_025:  mov     eax, dword [ebp-4H]                     ; 086E _ 8B. 45, FC
        ...
        add     eax, cursor.1655                        ; 087B _ 05, 00000060(d)
...
?_026:  mov     eax, dword [ebp-4H]                     ; 08A0 _ 8B. 45, FC
        ...
        add     eax, cursor.1655                        ; 08AD _ 05, 00000060(d)
...
intHandlerFromC:; Function begin
        ...
        movzx   eax, word [?_083]                       ; 096F _ 0F B7. 05, 00000104(d)
        cwde                                            ; 0976 _ 98
        mov     dword [ebp-10H], eax                    ; 0977 _ 89. 45, F0
        movzx   eax, word [?_084]                       ; 097A _ 0F B7. 05, 00000106(d)
        cwde                                            ; 0981 _ 98
...
charToHexStr:; Function begin
        ...
        mov     byte [?_082], al                        ; 0A07 _ A2, 00000007(d)
        ...
        mov     byte [?_081], al                        ; 0A20 _ A2, 00000006(d)
        mov     eax, keyval                             ; 0A25 _ B8, 00000004(d)
        leave                                           ; 0A2A _ C9
        ret                                             ; 0A2B _ C3
...
intToHexStr:; Function begin
        ...
        mov     byte [str.1702], 48                     ; 0A32 _ C6. 05, 000001FC(d), 30
        mov     byte [?_085], 88                        ; 0A39 _ C6. 05, 000001FD(d), 58
        mov     byte [?_086], 0                         ; 0A40 _ C6. 05, 00000206(d), 00
...
?_036:  mov     eax, dword [ebp+8H]                     ; 0A57 _ 8B. 45, 08
        ...
        mov     byte [str.1702+eax], dl                 ; 0A76 _ 88. 90, 000001FC(d)
...
?_037:  mov     eax, dword [ebp-4H]                     ; 0A7E _ 8B. 45, FC
        ...
        mov     byte [str.1702+eax], dl                 ; 0A8E _ 88. 90, 000001FC(d)
...
?_039:  cmp     dword [ebp-0CH], 0                      ; 0A9C _ 83. 7D, F4, 00
        ...
        mov     eax, str.1702                           ; 0AA2 _ B8, 000001FC(d)
        leave                                           ; 0AA7 _ C9
        ret                                             ; 0AA8 _ C3
...
computeMousePosition:; Function begin
        ...
        movzx   eax, word [?_083]                       ; 0E08 _ 0F B7. 05, 00000104(d)
        cwde                                            ; 0E0F _ 98
        mov     dword [ebp-8H], eax                     ; 0E10 _ 89. 45, F8
        movzx   eax, word [?_084]                       ; 0E13 _ 0F B7. 05, 00000106(d)
        cwde                                            ; 0E1A _ 98
...
eraseMouse:; Function begin
        ...
        movzx   eax, word [?_083]                       ; 0EA6 _ 0F B7. 05, 00000104(d)
        cwde                                            ; 0EAD _ 98
        mov     dword [ebp-0CH], eax                    ; 0EAE _ 89. 45, F4
        movzx   eax, word [?_084]                       ; 0EB1 _ 0F B7. 05, 00000106(d)
        cwde                                            ; 0EB8 _ 98
...
drawMouse:; Function begin
        ...
        movzx   eax, word [?_083]                       ; 0EF7 _ 0F B7. 05, 00000104(d)
        cwde                                            ; 0EFE _ 98
        mov     dword [ebp-8H], eax                     ; 0EFF _ 89. 45, F8
        movzx   eax, word [?_084]                       ; 0F02 _ 0F B7. 05, 00000106(d)
        cwde                                            ; 0F09 _ 98
...
showMemoryInfo:; Function begin
        ...
        push    ?_075                                   ; 0FD9 _ 68, 00000013(d)
        push    eax                                     ; 0FDE _ 50
        ...
        push    ?_076                                   ; 1033 _ 68, 0000001D(d)
        push    eax                                     ; 1038 _ 50
        ...
        push    ?_077                                   ; 108F _ 68, 00000029(d)
        push    eax                                     ; 1094 _ 50
        ...
        push    ?_078                                   ; 10EC _ 68, 00000035(d)
        push    eax                                     ; 10F1 _ 50
        ...
        push    ?_079                                   ; 1149 _ 68, 00000041(d)
        push    eax                                     ; 114E _ 50
        ...
        push    ?_080                                   ; 11A6 _ 68, 0000004E(d)
        push    eax                                     ; 11AB _ 50
...
memman_free:; Function begin
        ...
        sub     esp, 16                                 ; 12E9 _ 83. EC, 10
        mov     dword [ebp-4H], 0                       ; 12EC _ C7. 45, FC, 00000000
        jmp     ?_070                                   ; 12F3 _ EB, 15

?_069:  mov     eax, dword [ebp+8H]                     ; 12F5 _ 8B. 45, 08
        mov     edx, dword [ebp-4H]                     ; 12F8 _ 8B. 55, FC
        add     edx, 2                                  ; 12FB _ 83. C2, 02
        mov     eax, dword [eax+edx*8]                  ; 12FE _ 8B. 04 D0
        cmp     dword [ebp+0CH], eax                    ; 1301 _ 39. 45, 0C
        jc      ?_071                                   ; 1304 _ 72, 10
        add     dword [ebp-4H], 1                       ; 1306 _ 83. 45, FC, 01
?_070:  mov     eax, dword [ebp+8H]                     ; 130A _ 8B. 45, 08
        mov     eax, dword [eax]                        ; 130D _ 8B. 00
        cmp     dword [ebp-4H], eax                     ; 130F _ 39. 45, FC
        jl      ?_069                                   ; 1312 _ 7C, E1
        jmp     ?_072                                   ; 1314 _ EB, 01
...
SECTION .eh_frame align=4 noexecute                     ; section number 3, const
        ...
        dd CMain-$+4BEH                                 ; 005C _ 0000051A (rel)
        ...
        dd CMain-$+4BBH                                 ; 007C _ 00000537 (rel)
        ...
        dd CMain-$+547H                                 ; 009C _ 000005E3 (rel)
        ...
        dd CMain-$+579H                                 ; 00BC _ 00000635 (rel)
        ...
        dd CMain-$+5ABH                                 ; 00DC _ 00000687 (rel)
        ...
        dd CMain-$+71CH                                 ; 00FC _ 00000818 (rel)
        ...
        dd CMain-$+7D6H                                 ; 011C _ 000008F2 (rel)
        ...
        dd 0000001CH, 0000013CH                         ; 0138 _ 28 316 
        dd CMain-$+821H                                 ; 0140 _ 00000961 (rel)
        dd 0000005FH, 080E4100H                         ; 0144 _ 95 135151872 
        dd 0D420285H, 0C55B0205H                        ; 014C _ 222429829 -983891451 
        dd 0004040CH, 0000001CH                         ; 0154 _ 263180 28 
        dd 0000015CH                                    ; 015C _ 348 
        dd CMain-$+860H                                 ; 0160 _ 000009C0 (rel)
        dd 00000024H, 080E4100H                         ; 0164 _ 36 135151872 
        dd 0D420285H, 0CC56005H                         ; 016C _ 222429829 214261765 
        dd 00000404H, 0000001CH                         ; 0174 _ 1028 28 
        dd 0000017CH                                    ; 017C _ 380 
        dd CMain-$+864H                                 ; 0180 _ 000009E4 (rel)
        dd 00000048H, 080E4100H                         ; 0184 _ 72 135151872 
        dd 0D420285H, 0C5440205H                        ; 018C _ 222429829 -985398779 
        dd 0004040CH, 0000001CH                         ; 0194 _ 263180 28 
        dd 0000019CH                                    ; 019C _ 412 
        dd CMain-$+88CH                                 ; 01A0 _ 00000A2C (rel)
        dd 0000007DH, 080E4100H                         ; 01A4 _ 125 135151872 
        dd 0D420285H, 0C5790205H                        ; 01AC _ 222429829 -981925371 
        dd 0004040CH, 0000001CH                         ; 01B4 _ 263180 28 
        dd 000001BCH                                    ; 01BC _ 444 
        dd CMain-$+8E9H                                 ; 01C0 _ 00000AA9 (rel)
        dd 00000020H, 080E4100H                         ; 01C4 _ 32 135151872 
        dd 0D420285H, 0CC55C05H                         ; 01CC _ 222429829 214260741 
        dd 00000404H, 0000001CH                         ; 01D4 _ 1028 28 
        dd 000001DCH                                    ; 01DC _ 476 
        dd CMain-$+8E9H                                 ; 01E0 _ 00000AC9 (rel)
        dd 00000031H, 080E4100H                         ; 01E4 _ 49 135151872 
        dd 0D420285H, 0CC56D05H                         ; 01EC _ 222429829 214265093 
        dd 00000404H, 0000001CH                         ; 01F4 _ 1028 28 
        dd 000001FCH                                    ; 01FC _ 508 
        dd CMain-$+8FAH                                 ; 0200 _ 00000AFA (rel)
        dd 00000037H, 080E4100H                         ; 0204 _ 55 135151872 
        dd 0D420285H, 0CC57305H                         ; 020C _ 222429829 214266629 
        dd 00000404H, 0000001CH                         ; 0214 _ 1028 28 
        dd 0000021CH                                    ; 021C _ 540 
        dd CMain-$+911H                                 ; 0220 _ 00000B31 (rel)
        dd 0000004FH, 080E4100H                         ; 0224 _ 79 135151872 
        dd 0D420285H, 0C54B0205H                        ; 022C _ 222429829 -984940027 
        dd 0004040CH, 0000001CH                         ; 0234 _ 263180 28 
        dd 0000023CH                                    ; 023C _ 572 
        dd CMain-$+940H                                 ; 0240 _ 00000B80 (rel)
        dd 0000003EH, 080E4100H                         ; 0244 _ 62 135151872 
        dd 0D420285H, 0CC57A05H                         ; 024C _ 222429829 214268421 
        dd 00000404H, 0000001CH                         ; 0254 _ 1028 28 
        dd 0000025CH                                    ; 025C _ 604 
        dd CMain-$+95EH                                 ; 0260 _ 00000BBE (rel)
        dd 00000080H, 080E4100H                         ; 0264 _ 128 135151872 
        dd 0D420285H, 0C57C0205H                        ; 026C _ 222429829 -981728763 
        dd 0004040CH, 0000001CH                         ; 0274 _ 263180 28 
        dd 0000027CH                                    ; 027C _ 636 
        dd CMain-$+9BEH                                 ; 0280 _ 00000C3E (rel)
        dd 00000070H, 080E4100H                         ; 0284 _ 112 135151872 
        dd 0D420285H, 0C56C0205H                        ; 028C _ 222429829 -982777339 
        dd 0004040CH, 0000001CH                         ; 0294 _ 263180 28 
        dd 0000029CH                                    ; 029C _ 668 
        dd CMain-$+0A0EH                                ; 02A0 _ 00000CAE (rel)
        dd 00000015H, 080E4100H                         ; 02A4 _ 21 135151872 
        dd 0D420285H, 0CC55105H                         ; 02AC _ 222429829 214257925 
        dd 00000404H, 0000001CH                         ; 02B4 _ 1028 28 
        dd 000002BCH                                    ; 02BC _ 700 
        dd CMain-$+0A03H                                ; 02C0 _ 00000CC3 (rel)
        dd 0000013FH, 080E4100H                         ; 02C4 _ 319 135151872 
        dd 0D420285H, 013B0305H                         ; 02CC _ 222429829 20644613 
        dd 04040CC5H, 0000001CH                         ; 02D4 _ 67374277 28 
        dd 000002DCH                                    ; 02DC _ 732 
        dd CMain-$+0B22H                                ; 02E0 _ 00000E02 (rel)
        dd 0000009DH, 080E4100H                         ; 02E4 _ 157 135151872 
        dd 0D420285H, 0C5990205H                        ; 02EC _ 222429829 -979828219 
        dd 0004040CH, 00000020H                         ; 02F4 _ 263180 32 
        dd 000002FCH                                    ; 02FC _ 764 
        dd CMain-$+0B9FH                                ; 0300 _ 00000E9F (rel)
        dd 00000052H, 080E4100H                         ; 0304 _ 82 135151872 
        dd 0D420285H, 03834405H                         ; 030C _ 222429829 58934277 
        dd 0C3C54A02H, 0004040CH                        ; 0314 _ -1010480638 263180 
        dd 0000001CH, 00000320H                         ; 031C _ 28 800 
        dd CMain-$+0BCDH                                ; 0324 _ 00000EF1 (rel)
        dd 00000045H, 080E4100H                         ; 0328 _ 69 135151872 
        dd 0D420285H, 0C5410205H                        ; 0330 _ 222429829 -985595387 
        dd 0004040CH, 0000001CH                         ; 0338 _ 263180 28 
        dd 00000340H                                    ; 0340 _ 832 
        dd CMain-$+0BF2H                                ; 0344 _ 00000F36 (rel)
        dd 0000005FH, 080E4100H                         ; 0348 _ 95 135151872 
        dd 0D420285H, 0C55B0205H                        ; 0350 _ 222429829 -983891451 
        dd 0004040CH, 0000001CH                         ; 0358 _ 263180 28 
        dd 00000360H                                    ; 0360 _ 864 
        dd CMain-$+0C31H                                ; 0364 _ 00000F95 (rel)
        dd 00000264H, 080E4100H                         ; 0368 _ 612 135151872 
        dd 0D420285H, 02600305H                         ; 0370 _ 222429829 39846661 
        dd 04040CC5H, 00000014H                         ; 0378 _ 67374277 20 
        dd 00000000H, 00527A01H                         ; 0380 _ 0 5405185 
        dd 01087C01H, 04040C1BH                         ; 0388 _ 17333249 67374107 
        dd 00000188H, 0000001CH                         ; 0390 _ 392 28 
        dd 0000001CH                                    ; 0398 _ 28 
        dd CMain-$+0E5DH                                ; 039C _ 000011F9 (rel)
        dd 0000002DH, 080E4100H                         ; 03A0 _ 45 135151872 
        dd 0D420285H, 0CC56905H                         ; 03A8 _ 222429829 214264069 
        dd 00000404H, 0000001CH                         ; 03B0 _ 1028 28 
        dd 0000003CH                                    ; 03B8 _ 60 
        dd CMain-$+0E6AH                                ; 03BC _ 00001226 (rel)
        dd 00000039H, 080E4100H                         ; 03C0 _ 57 135151872 
        dd 0D420285H, 0CC57505H                         ; 03C8 _ 222429829 214267141 
        dd 00000404H, 0000001CH                         ; 03D0 _ 1028 28 
        dd 0000005CH                                    ; 03D8 _ 92 
        dd CMain-$+0E83H                                ; 03DC _ 0000125F (rel)
        dd 00000087H, 080E4100H                         ; 03E0 _ 135 135151872 
        dd 0D420285H, 0C5830205H                        ; 03E8 _ 222429829 -981270011 
        dd 0004040CH, 0000001CH                         ; 03F0 _ 263180 28 
        dd 0000007CH                                    ; 03F8 _ 124 
        dd CMain-$+0EEAH                                ; 03FC _ 000012E6 (rel)
        dd 00000034H, 080E4100H                         ; 0400 _ 52 135151872 
        dd 0D420285H, 0CC57005H                         ; 0408 _ 222429829 214265861 
        dd 00000404H                                    ; 0410 _ 1028 
...
keyval:                                                 ; byte
        db 30H, 78H                                     ; 0004 _ 0x

?_081:  db 00H                                          ; 0006 _ .

?_082:  db 00H, 00H, 00H, 00H, 00H, 00H, 00H, 00H       ; 0007 _ ........
