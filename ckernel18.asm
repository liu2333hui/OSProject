...
SECTION .eh_frame align=4 noexecute                     ; section number 3, const
        ...
        dd CMain-$+418H                                 ; 005C _ 00000474 (rel)
        ...
        dd CMain-$+415H                                 ; 007C _ 00000491 (rel)
        ...
        dd CMain-$+4A1H                                 ; 009C _ 0000053D (rel)
        ...
        dd CMain-$+4D3H                                 ; 00BC _ 0000058F (rel)
        ...
        dd CMain-$+505H                                 ; 00DC _ 000005E1 (rel)
        ...
        dd CMain-$+676H                                 ; 00FC _ 00000772 (rel)
        ...
        dd CMain-$+730H                                 ; 011C _ 0000084C (rel)
        ...
        dd CMain-$+77BH                                 ; 0140 _ 000008BB (rel)
        ...
        dd CMain-$+7BAH                                 ; 0160 _ 0000091A (rel)
        ...
        dd CMain-$+7BEH                                 ; 0180 _ 0000093E (rel)
        ...
        dd CMain-$+7E6H                                 ; 01A0 _ 00000986 (rel)
        ...
        dd CMain-$+843H                                 ; 01C0 _ 00000A03 (rel)
        ...
        dd CMain-$+843H                                 ; 01E0 _ 00000A23 (rel)
        ...
        dd CMain-$+854H                                 ; 0200 _ 00000A54 (rel)
        dd 0000003EH, 080E4100H                         ; 0204 _ 62 135151872 
        dd 0D420285H, 0CC57A05H                         ; 020C _ 222429829 214268421 
        dd 00000404H, 0000001CH                         ; 0214 _ 1028 28 
        dd 0000021CH                                    ; 021C _ 540 
        dd CMain-$+872H                                 ; 0220 _ 00000A92 (rel)
        ...
        dd CMain-$+8A1H                                 ; 0240 _ 00000AE1 (rel)
        ...
        dd CMain-$+8BFH                                 ; 0260 _ 00000B1F (rel)
        ...
        dd CMain-$+91FH                                 ; 0280 _ 00000B9F (rel)
        ...
        dd CMain-$+96FH                                 ; 02A0 _ 00000C0F (rel)
        ...
        dd CMain-$+964H                                 ; 02C0 _ 00000C24 (rel)
        ...
        dd CMain-$+0A83H                                ; 02E0 _ 00000D63 (rel)
        dd 0000009DH, 080E4100H                         ; 02E4 _ 157 135151872 
        dd 0D420285H, 0C5990205H                        ; 02EC _ 222429829 -979828219 
        dd 0004040CH, 0000001CH                         ; 02F4 _ 263180 28 
        dd 000002FCH                                    ; 02FC _ 764 
        dd CMain-$+0B00H                                ; 0300 _ 00000E00 (rel)
        dd 00000064H, 080E4100H                         ; 0304 _ 100 135151872 
        dd 0D420285H, 0C5600205H                        ; 030C _ 222429829 -983563771 
        dd 0004040CH, 0000001CH                         ; 0314 _ 263180 28 
        dd 0000031CH                                    ; 031C _ 796 
        dd CMain-$+0B44H                                ; 0320 _ 00000E64 (rel)
        dd 00000264H, 080E4100H                         ; 0324 _ 612 135151872 
        dd 0D420285H, 02600305H                         ; 032C _ 222429829 39846661 
        dd 04040CC5H, 00000020H                         ; 0334 _ 67374277 32 
        dd 0000033CH                                    ; 033C _ 828 
        dd CMain-$+0D88H                                ; 0340 _ 000010C8 (rel)
        dd 0000021DH, 080E4100H                         ; 0344 _ 541 135151872 
        dd 0D420285H, 03834105H                         ; 034C _ 222429829 58933509 
        dd 0C5021803H, 04040CC3H                        ; 0354 _ -989718525 67374275 
        dd 00000014H, 00000000H                         ; 035C _ 20 0 
        dd 00527A01H, 01087C01H                         ; 0364 _ 5405185 17333249 
        dd 04040C1BH, 00000188H                         ; 036C _ 67374107 392 
        dd 0000001CH, 0000001CH                         ; 0374 _ 28 28 
        dd CMain-$+0F69H                                ; 037C _ 000012E5 (rel)
        dd 0000002DH, 080E4100H                         ; 0380 _ 45 135151872 
        dd 0D420285H, 0CC56905H                         ; 0388 _ 222429829 214264069 
        dd 00000404H, 0000001CH                         ; 0390 _ 1028 28 
        dd 0000003CH                                    ; 0398 _ 60 
        dd CMain-$+0F76H                                ; 039C _ 00001312 (rel)
        dd 00000039H, 080E4100H                         ; 03A0 _ 57 135151872 
        dd 0D420285H, 0CC57505H                         ; 03A8 _ 222429829 214267141 
        dd 00000404H, 0000001CH                         ; 03B0 _ 1028 28 
        dd 0000005CH                                    ; 03B8 _ 92 
        dd CMain-$+0F8FH                                ; 03BC _ 0000134B (rel)
        dd 000000ACH, 080E4100H                         ; 03C0 _ 172 135151872 
        dd 0D420285H, 0C5A80205H                        ; 03C8 _ 222429829 -978845179 
        dd 0004040CH, 00000024H                         ; 03D0 _ 263180 36 
        dd 0000007CH                                    ; 03D8 _ 124 
        dd CMain-$+101BH                                ; 03DC _ 000013F7 (rel)
        dd 00000216H, 080E4100H                         ; 03E0 _ 534 135151872 
        dd 0D420285H, 03834405H                         ; 03E8 _ 222429829 58934277 
        dd 0C3020D03H, 040CC541H                        ; 03F0 _ -1023275773 67945793 
        dd 00000004H, 0000001CH                         ; 03F8 _ 4 28 
        dd 000000A4H                                    ; 0400 _ 164 
        dd CMain-$+1209H                                ; 0404 _ 0000160D (rel)
        dd 0000002CH, 080E4100H                         ; 0408 _ 44 135151872 
        dd 0D420285H, 0CC56805H                         ; 0410 _ 222429829 214263813 
        dd 00000404H, 0000001CH                         ; 0418 _ 1028 28 
        dd 000000C4H                                    ; 0420 _ 196 
        dd CMain-$+1215H                                ; 0424 _ 00001639 (rel)
        dd 0000002FH, 080E4100H                         ; 0428 _ 47 135151872 
        dd 0D420285H, 0CC56B05H                         ; 0430 _ 222429829 214264581 
        dd 00000404H, 00000014H                         ; 0438 _ 1028 20 
        dd 00000000H, 00527A01H                         ; 0440 _ 0 5405185 
        dd 01087C01H, 04040C1BH                         ; 0448 _ 17333249 67374107 
        dd 00000188H, 0000001CH                         ; 0450 _ 392 28 
        dd 0000001CH                                    ; 0458 _ 28 
        dd CMain-$+120CH                                ; 045C _ 00001668 (rel)
        dd 0000007FH, 080E4100H                         ; 0460 _ 127 135151872 
        dd 0D420285H, 0C57B0205H                        ; 0468 _ 222429829 -981794299 
        dd 0004040CH, 0000001CH                         ; 0470 _ 263180 28 
        dd 0000003CH                                    ; 0478 _ 60 
        dd CMain-$+126BH                                ; 047C _ 000016E7 (rel)
        dd 00000076H, 080E4100H                         ; 0480 _ 118 135151872 
        dd 0D420285H, 0C5720205H                        ; 0488 _ 222429829 -982384123 
        dd 0004040CH, 0000001CH                         ; 0490 _ 263180 28 
        dd 0000005CH                                    ; 0498 _ 92 
        dd CMain-$+12C1H                                ; 049C _ 0000175D (rel)
        dd 00000029H, 080E4100H                         ; 04A0 _ 41 135151872 
        dd 0D420285H, 0CC56505H                         ; 04A8 _ 222429829 214263045 
        dd 00000404H, 0000001CH                         ; 04B0 _ 1028 28 
        dd 0000007CH                                    ; 04B8 _ 124 
        dd CMain-$+12CAH                                ; 04BC _ 00001786 (rel)
        dd 000001F1H, 080E4100H                         ; 04C0 _ 497 135151872 
        dd 0D420285H, 01ED0305H                         ; 04C8 _ 222429829 32310021 
        dd 04040CC5H, 0000001CH                         ; 04D0 _ 67374277 28 
        dd 0000009CH                                    ; 04D8 _ 156 
        dd CMain-$+149BH                                ; 04DC _ 00001977 (rel)
        dd 000000E8H, 080E4100H                         ; 04E0 _ 232 135151872 
        dd 0D420285H, 0C5E40205H                        ; 04E8 _ 222429829 -974913019 
        dd 0004040CH, 0000001CH                         ; 04F0 _ 263180 28 
        dd 000000BCH                                    ; 04F8 _ 188 
        dd CMain-$+1563H                                ; 04FC _ 00001A5F (rel)
        dd 0000002DH, 080E4100H                         ; 0500 _ 45 135151872 
        dd 0D420285H, 0CC56905H                         ; 0508 _ 222429829 214264069 
        dd 00000404H                                    ; 0510 _ 1028 
