; Disassembly of file: /home/bobkuo/eclipse-workspace/nasmCode/write_vga_mouse_mov.o
; Fri Apr 24 09:43:36 2020
; Mode: 32 bits
; Syntax: YASM/NASM
...
SECTION .eh_frame align=4 noexecute                     ; section number 4, const
        ...
        dd CMain-$+3A0H                                 ; 005C _ 000003FC (rel)
        ...
        dd CMain-$+39DH                                 ; 007C _ 00000419 (rel)
        ...
        dd CMain-$+429H                                 ; 009C _ 000004C5 (rel)
        ...
        dd CMain-$+45BH                                 ; 00BC _ 00000517 (rel)
        ...
        dd CMain-$+48DH                                 ; 00DC _ 00000569 (rel)
        ...
        dd CMain-$+5FEH                                 ; 00FC _ 000006FA (rel)
        ...
        dd CMain-$+6B8H                                 ; 011C _ 000007D4 (rel)
        ...
        dd CMain-$+703H                                 ; 0140 _ 00000843 (rel)
        ...
        dd CMain-$+742H                                 ; 0160 _ 000008A2 (rel)
        ...
        dd CMain-$+746H                                 ; 0180 _ 000008C6 (rel)
        ...
        dd CMain-$+76EH                                 ; 01A0 _ 0000090E (rel)
        dd 00000020H, 080E4100H                         ; 01A4 _ 32 135151872 
        dd 0D420285H, 0CC55C05H                         ; 01AC _ 222429829 214260741 
        dd 00000404H, 0000001CH                         ; 01B4 _ 1028 28 
        dd 000001BCH                                    ; 01BC _ 444 
        dd CMain-$+76EH                                 ; 01C0 _ 0000092E (rel)
        dd 00000031H, 080E4100H                         ; 01C4 _ 49 135151872 
        dd 0D420285H, 0CC56D05H                         ; 01CC _ 222429829 214265093 
        dd 00000404H, 0000001CH                         ; 01D4 _ 1028 28 
        dd 000001DCH                                    ; 01DC _ 476 
        dd CMain-$+77FH                                 ; 01E0 _ 0000095F (rel)
        dd 00000037H, 080E4100H                         ; 01E4 _ 55 135151872 
        dd 0D420285H, 0CC57305H                         ; 01EC _ 222429829 214266629 
        dd 00000404H, 0000001CH                         ; 01F4 _ 1028 28 
        dd 000001FCH                                    ; 01FC _ 508 
        dd CMain-$+796H                                 ; 0200 _ 00000996 (rel)
        dd 0000004FH, 080E4100H                         ; 0204 _ 79 135151872 
        dd 0D420285H, 0C54B0205H                        ; 020C _ 222429829 -984940027 
        dd 0004040CH, 0000001CH                         ; 0214 _ 263180 28 
        dd 0000021CH                                    ; 021C _ 540 
        dd CMain-$+7C5H                                 ; 0220 _ 000009E5 (rel)
        dd 0000003EH, 080E4100H                         ; 0224 _ 62 135151872 
        dd 0D420285H, 0CC57A05H                         ; 022C _ 222429829 214268421 
        dd 00000404H, 0000001CH                         ; 0234 _ 1028 28 
        dd 0000023CH                                    ; 023C _ 572 
        dd CMain-$+7E3H                                 ; 0240 _ 00000A23 (rel)
        dd 00000080H, 080E4100H                         ; 0244 _ 128 135151872 
        dd 0D420285H, 0C57C0205H                        ; 024C _ 222429829 -981728763 
        dd 0004040CH, 0000001CH                         ; 0254 _ 263180 28 
        dd 0000025CH                                    ; 025C _ 604 
        dd intHandlerFromC-$+260H                       ; 0260 _ 00000AA3 (rel)
        dd 00000070H, 080E4100H                         ; 0264 _ 112 135151872 
        dd 0D420285H, 0C56C0205H                        ; 026C _ 222429829 -982777339 
        dd 0004040CH, 0000001CH                         ; 0274 _ 263180 28 
        dd 0000027CH                                    ; 027C _ 636 
        dd CMain-$+893H                                 ; 0280 _ 00000B13 (rel)
        dd 00000015H, 080E4100H                         ; 0284 _ 21 135151872 
        dd 0D420285H, 0CC55105H                         ; 028C _ 222429829 214257925 
        dd 00000404H, 0000001CH                         ; 0294 _ 1028 28 
        dd 0000029CH                                    ; 029C _ 668 
        dd CMain-$+888H                                 ; 02A0 _ 00000B28 (rel)
        dd 0000013FH, 080E4100H                         ; 02A4 _ 319 135151872 
        dd 0D420285H, 013B0305H                         ; 02AC _ 222429829 20644613 
        dd 04040CC5H, 0000001CH                         ; 02B4 _ 67374277 28 
        dd 000002BCH                                    ; 02BC _ 700 
        dd CMain-$+9A7H                                 ; 02C0 _ 00000C67 (rel)
        dd 0000009DH, 080E4100H                         ; 02C4 _ 157 135151872 
        dd 0D420285H, 0C5990205H                        ; 02CC _ 222429829 -979828219 
        dd 0004040CH, 00000020H                         ; 02D4 _ 263180 32 
        dd 000002DCH                                    ; 02DC _ 732 
        dd CMain-$+0A24H                                ; 02E0 _ 00000D04 (rel)
        dd 00000052H, 080E4100H                         ; 02E4 _ 82 135151872 
        dd 0D420285H, 03834405H                         ; 02EC _ 222429829 58934277 
        dd 0C3C54A02H, 0004040CH                        ; 02F4 _ -1010480638 263180 
        dd 0000001CH, 00000300H                         ; 02FC _ 28 768 
        dd CMain-$+0A52H                                ; 0304 _ 00000D56 (rel)
        dd 00000045H, 080E4100H                         ; 0308 _ 69 135151872 
        dd 0D420285H, 0C5410205H                        ; 0310 _ 222429829 -985595387 
        dd 0004040CH, 0000001CH                         ; 0318 _ 263180 28 
        dd 00000320H                                    ; 0320 _ 800 
        dd CMain-$+0A77H                                ; 0324 _ 00000D9B (rel)
        dd 0000005FH, 080E4100H                         ; 0328 _ 95 135151872 
        dd 0D420285H, 0C55B0205H                        ; 0330 _ 222429829 -983891451 
        dd 0004040CH                                    ; 0338 _ 263180 
