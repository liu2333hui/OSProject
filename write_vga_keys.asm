; Disassembly of file: /home/bobkuo/eclipse-workspace/nasmCode/write_vga_keys.o
; Wed Apr 22 22:27:00 2020
; Mode: 32 bits
; Syntax: YASM/NASM
...
SECTION .eh_frame align=4 noexecute                     ; section number 4, const
        ...
        dd CMain-$+328H                                 ; 005C _ 00000384 (rel)
        ...
        dd CMain-$+325H                                 ; 007C _ 000003A1 (rel)
        ...
        dd CMain-$+3B1H                                 ; 009C _ 0000044D (rel)
        ...
        dd CMain-$+3E3H                                 ; 00BC _ 0000049F (rel)
        ...
        dd CMain-$+415H                                 ; 00DC _ 000004F1 (rel)
        ...
        dd CMain-$+586H                                 ; 00FC _ 00000682 (rel)
        ...
        dd CMain-$+640H                                 ; 011C _ 0000075C (rel)
        ...
        dd CMain-$+68BH                                 ; 0140 _ 000007CB (rel)
        dd 00000080H, 080E4100H                         ; 0144 _ 128 135151872 
        dd 0D420285H, 0C57C0205H                        ; 014C _ 222429829 -981728763 
        dd 0004040CH, 0000001CH                         ; 0154 _ 263180 28 
        dd 0000015CH                                    ; 015C _ 348 
        dd CMain-$+6EBH                                 ; 0160 _ 0000084B (rel)
