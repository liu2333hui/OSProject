; Disassembly of file: /home/bobkuo/eclipse-workspace/nasmCode/ckernel20.o
; Tue Apr 28 23:14:04 2020
; Mode: 32 bits
; Syntax: YASM/NASM
...
SECTION .eh_frame align=4 noexecute                     ; section number 3, const
        ...
        dd CMain-$+2F8H                                 ; 005C _ 00000354 (rel)
        ...
        dd CMain-$+2F5H                                 ; 007C _ 00000371 (rel)
        ...
        dd CMain-$+381H                                 ; 009C _ 0000041D (rel)
        ...
        dd CMain-$+3B3H                                 ; 00BC _ 0000046F (rel)
        ...
        dd CMain-$+413H                                 ; 00E0 _ 000004F3 (rel)
        ...
        dd CMain-$+584H                                 ; 0100 _ 00000684 (rel)
        ...
        dd CMain-$+63EH                                 ; 0120 _ 0000075E (rel)
        ...
        dd CMain-$+689H                                 ; 0144 _ 000007CD (rel)
        ...
        dd CMain-$+6C8H                                 ; 0164 _ 0000082C (rel)
        ...
        dd CMain-$+6CCH                                 ; 0184 _ 00000850 (rel)
        ...
        dd CMain-$+6F4H                                 ; 01A4 _ 00000898 (rel)
        ...
        dd ?_028-$+1C4H                                 ; 01C4 _ 00000915 (rel)
        ...
        dd ?_028-$+1E4H                                 ; 01E4 _ 00000935 (rel)
        ...
        dd CMain-$+762H                                 ; 0204 _ 00000966 (rel)
        ...
        dd CMain-$+780H                                 ; 0224 _ 000009A4 (rel)
        ...
        dd CMain-$+7AFH                                 ; 0244 _ 000009F3 (rel)
        ...
        dd intHandlerFromC-$+264H                       ; 0264 _ 00000A31 (rel)
        ...
        dd CMain-$+82DH                                 ; 0284 _ 00000AB1 (rel)
        ...
        dd CMain-$+87DH                                 ; 02A4 _ 00000B21 (rel)
        ...
        dd CMain-$+872H                                 ; 02C4 _ 00000B36 (rel)
        ...
        dd CMain-$+991H                                 ; 02E4 _ 00000C75 (rel)
        dd 000000B9H, 080E4100H                         ; 02E8 _ 185 135151872 
        dd 0D420285H, 0C5B50205H                        ; 02F0 _ 222429829 -977993211 
        dd 0004040CH, 0000001CH                         ; 02F8 _ 263180 28 
        dd 00000300H                                    ; 0300 _ 768 
        dd CMain-$+0A2AH                                ; 0304 _ 00000D2E (rel)
        ...
        dd CMain-$+0A77H                                ; 0324 _ 00000D9B (rel)
        ...
        dd CMain-$+0CBDH                                ; 0344 _ 00001001 (rel)
        ...
        dd 00000014H, 00000000H                         ; 0360 _ 20 0 
        dd 00527A01H, 01087C01H                         ; 0368 _ 5405185 17333249 
        dd 04040C1BH, 00000188H                         ; 0370 _ 67374107 392 
        dd 0000001CH, 0000001CH                         ; 0378 _ 28 28 
        dd CMain-$+0E9EH                                ; 0380 _ 0000121E (rel)
        dd 0000002DH, 080E4100H                         ; 0384 _ 45 135151872 
        dd 0D420285H, 0CC56905H                         ; 038C _ 222429829 214264069 
        dd 00000404H, 0000001CH                         ; 0394 _ 1028 28 
        dd 0000003CH                                    ; 039C _ 60 
        dd CMain-$+0EABH                                ; 03A0 _ 0000124B (rel)
        dd 00000039H, 080E4100H                         ; 03A4 _ 57 135151872 
        dd 0D420285H, 0CC57505H                         ; 03AC _ 222429829 214267141 
        dd 00000404H, 0000001CH                         ; 03B4 _ 1028 28 
        dd 0000005CH                                    ; 03BC _ 92 
        dd CMain-$+0EC4H                                ; 03C0 _ 00001284 (rel)
        dd 000000ACH, 080E4100H                         ; 03C4 _ 172 135151872 
        dd 0D420285H, 0C5A80205H                        ; 03CC _ 222429829 -978845179 
        dd 0004040CH, 00000024H                         ; 03D4 _ 263180 36 
        dd 0000007CH                                    ; 03DC _ 124 
        dd CMain-$+0F50H                                ; 03E0 _ 00001330 (rel)
        dd 00000216H, 080E4100H                         ; 03E4 _ 534 135151872 
        dd 0D420285H, 03834405H                         ; 03EC _ 222429829 58934277 
        dd 0C3020D03H, 040CC541H                        ; 03F4 _ -1023275773 67945793 
        dd 00000004H, 0000001CH                         ; 03FC _ 4 28 
        dd 000000A4H                                    ; 0404 _ 164 
        dd CMain-$+113EH                                ; 0408 _ 00001546 (rel)
        dd 0000002CH, 080E4100H                         ; 040C _ 44 135151872 
        dd 0D420285H, 0CC56805H                         ; 0414 _ 222429829 214263813 
        dd 00000404H, 0000001CH                         ; 041C _ 1028 28 
        dd 000000C4H                                    ; 0424 _ 196 
        dd CMain-$+114AH                                ; 0428 _ 00001572 (rel)
        dd 0000002FH, 080E4100H                         ; 042C _ 47 135151872 
        dd 0D420285H, 0CC56B05H                         ; 0434 _ 222429829 214264581 
        dd 00000404H, 00000014H                         ; 043C _ 1028 20 
        dd 00000000H, 00527A01H                         ; 0444 _ 0 5405185 
        dd 01087C01H, 04040C1BH                         ; 044C _ 17333249 67374107 
        dd 00000188H, 0000001CH                         ; 0454 _ 392 28 
        dd 0000001CH                                    ; 045C _ 28 
        dd CMain-$+1141H                                ; 0460 _ 000015A1 (rel)
        dd 0000007FH, 080E4100H                         ; 0464 _ 127 135151872 
        dd 0D420285H, 0C57B0205H                        ; 046C _ 222429829 -981794299 
        dd 0004040CH, 0000001CH                         ; 0474 _ 263180 28 
        dd 0000003CH                                    ; 047C _ 60 
        dd CMain-$+11A0H                                ; 0480 _ 00001620 (rel)
        dd 00000076H, 080E4100H                         ; 0484 _ 118 135151872 
        dd 0D420285H, 0C5720205H                        ; 048C _ 222429829 -982384123 
        dd 0004040CH, 0000001CH                         ; 0494 _ 263180 28 
        dd 0000005CH                                    ; 049C _ 92 
        dd CMain-$+11F6H                                ; 04A0 _ 00001696 (rel)
        dd 00000029H, 080E4100H                         ; 04A4 _ 41 135151872 
        dd 0D420285H, 0CC56505H                         ; 04AC _ 222429829 214263045 
        dd 00000404H, 00000020H                         ; 04B4 _ 1028 32 
        dd 0000007CH                                    ; 04BC _ 124 
        dd CMain-$+11FFH                                ; 04C0 _ 000016BF (rel)
        dd 00000251H, 080E4100H                         ; 04C4 _ 593 135151872 
        dd 0D420285H, 03834405H                         ; 04CC _ 222429829 58934277 
        dd 0C5024903H, 04040CC3H                        ; 04D4 _ -989705981 67374275 
        dd 00000024H, 000000A0H                         ; 04DC _ 36 160 
        dd CMain-$+142CH                                ; 04E4 _ 00001910 (rel)
        dd 0000005BH, 080E4100H                         ; 04E8 _ 91 135151872 
        dd 0D420285H, 03864205H                         ; 04F0 _ 222429829 59130373 
        dd 53020483H, 41C641C3H                         ; 04F8 _ 1392641155 1103512003 
        dd 04040CC5H, 0000001CH                         ; 0500 _ 67374277 28 
        dd 000000C8H                                    ; 0508 _ 200 
        dd CMain-$+145FH                                ; 050C _ 0000196B (rel)
        dd 0000008FH, 080E4100H                         ; 0510 _ 143 135151872 
        dd 0D420285H, 0C58B0205H                        ; 0518 _ 222429829 -980745723 
        dd 0004040CH, 0000001CH                         ; 0520 _ 263180 28 
        dd 000000E8H                                    ; 0528 _ 232 
        dd CMain-$+14CEH                                ; 052C _ 000019FA (rel)
        dd 00000108H, 080E4100H                         ; 0530 _ 264 135151872 
        dd 0D420285H, 01040305H                         ; 0538 _ 222429829 17040133 
        dd 04040CC5H                                    ; 0540 _ 67374277 
